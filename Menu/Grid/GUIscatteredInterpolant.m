function GUIscatteredInterpolant
...
GUIscatteredInterpolant_ = figure('Name','Grid Data Using Scattered Interpolant',...
    'Visible','off',...
    'NumberTitle','off',...
    'Units','pixel',...
...
uicontrol(GUIscatteredInterpolant_,'Style','pushbutton',...
    'units','normalized',...
    'String','Input Data',...
...
inputFile_path = uicontrol(GUIscatteredInterpolant_,'Style','edit',...
...
%--------------------------------------------------------------------------
colorDist = uicontrol(GUIscatteredInterpolant_,'Style','popupmenu',...
    'units','normalized',...
    'Value',1,...
    'String',{'Histogram Equalized','Linear'},...
    'TooltipString','Color Distribution.',...
    'fontUnits','normalized',...
    'position',[0.3 0.725 0.32 0.08]);

coordConversion = uicontrol(GUIscatteredInterpolant_,'Style','popupmenu',...
    'units','normalized',...
    'String',{'Use Original Units','From m to km','From m to m','From km to m','From km to km'},...
    'fontUnits','normalized',...
    'TooltipString','Convert axis units.',...
    'position',[0.63 0.725 0.32 0.08]);

minX_ = uicontrol(GUIscatteredInterpolant_,'Style','edit',...
    'units','normalized',...
    'String','',...
    'fontUnits','normalized',...
...
maxX_ = uicontrol(GUIscatteredInterpolant_,'Style','edit',...
    'units','normalized',...
    'String','',...
    'fontUnits','normalized',...
...
spaceX_ = uicontrol(GUIscatteredInterpolant_,'Style','edit',...
    'units','normalized',...
    'String','',...
    'fontUnits','normalized',...
...
nodesX_ = uicontrol(GUIscatteredInterpolant_,'Style','edit',...
    'units','normalized',...
    'String','',...
    'fontUnits','normalized',...
...
minY_ = uicontrol(GUIscatteredInterpolant_,'Style','edit',...
    'units','normalized',...
    'String','',...
    'fontUnits','normalized',...
...
maxY_ = uicontrol(GUIscatteredInterpolant_,'Style','edit',...
    'units','normalized',...
    'String','',...
    'fontUnits','normalized',...
...
spaceY_ = uicontrol(GUIscatteredInterpolant_,'Style','edit',...
    'units','normalized',...
    'String','',...
    'fontUnits','normalized',...
...
nodesY_ = uicontrol(GUIscatteredInterpolant_,'Style','edit',...
    'units','normalized',...
    'String','',...
    'fontUnits','normalized',...
...
popupMethod = uicontrol(GUIscatteredInterpolant_,'Style','popupmenu',...
    'units','normalized',...
    'Value',1,...
    'String',{'Linear','Natural Neighbor','Nearest Neighbor'},...
    'TooltipString','Color Distribution.',...
    'fontUnits','normalized',...
...
outputFile_path = uicontrol(GUIscatteredInterpolant_,'Style','edit',...
...
Cmenu = uicontextmenu(GUIscatteredInterpolant_);
set(GUIscatteredInterpolant_,'UIContextMenu',Cmenu)
uimenu(Cmenu,'Label','Copy the GUI variables into the MATLAB workspace','Callback',@copy2MATLABworkspace);

dataLoaded = 'n';
dataInterpolated = 'n';
set(GUIscatteredInterpolant_,'Visible','on')
%--------------------------------------------------------------------------
%CALLBACKS
%--------------------------------------------------------------------------
...
handles = guidata(GUIscatteredInterpolant_);
...
guidata(GUIscatteredInterpolant_,handles);
end
...
if(dataLoaded == 'y')
    ...
    if(get(popupMethod,'Value')==1)
        F = scatteredInterpolant(X,Y,Z,'linear');
    elseif(get(popupMethod,'Value')==2)
