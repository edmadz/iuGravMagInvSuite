...
GUIrtpGunn_ = figure('Name','Reduction to the Pole',...
    'Visible','off',...
    'NumberTitle','off',...
    'Units','pixel',...
...
uicontrol(GUIrtpGunn_,'Style','pushbutton',...
    'units','normalized',...
    'String','Input Data',...
...
inputFile_path = uicontrol(GUIrtpGunn_,'Style','edit',...
...
%--------------------------------------------------------------------------
popupDist = uicontrol(GUIrtpGunn_,'Style','popupmenu',...
    'units','normalized',...
    'Value',1,...
...
I_ = uicontrol(GUIrtpGunn_,'Style','edit',...
    'units','normalized',...
    'String','',...
    'fontUnits','normalized',...
...
D_ = uicontrol(GUIrtpGunn_,'Style','edit',...
    'units','normalized',...
    'String','',...
    'fontUnits','normalized',...
...
expansion_ = uicontrol(GUIrtpGunn_,'Style','edit',...
    'units','normalized',...
    'String','25',...
    'fontUnits','normalized',...
...
coordConversion = uicontrol(GUIrtpGunn_,'Style','popupmenu',...
    'units','normalized',...
...
outputFile_path = uicontrol(GUIrtpGunn_,'Style','edit',...
...
if(dataLoaded=='y')
    ...
    Zg_=rtp_G(Zg,I,D,exp);
    %rtp_=rtpBlakely(Zg,I,D,exp);
