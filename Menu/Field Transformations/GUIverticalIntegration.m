function GUIverticalIntegration
...
GUIverticalIntegration_ = figure('Name','Vertical Integration',...
    'Visible','off',...
    'NumberTitle','off',...
    'Units','pixel',...
...
uicontrol(GUIverticalIntegration_,'Style','pushbutton',...
    'units','normalized',...
    'String','Input Data',...
...
inputFile_path = uicontrol(GUIverticalIntegration_,'Style','edit',...
...
%--------------------------------------------------------------------------
popupDist = uicontrol(GUIverticalIntegration_,'Style','popupmenu',...
    'units','normalized',...
    'Value',1,...
...
expansion_ = uicontrol(GUIverticalIntegration_,'Style','edit',...
    'units','normalized',...
    'String','25',...
    'fontUnits','normalized',...
...
coordConversion = uicontrol(GUIverticalIntegration_,'Style','popupmenu',...
    'units','normalized',...
...
uicontrol(GUIverticalIntegration_,'Style','pushbutton',...
    'units','normalized',...
    'String','Apply Vertical Integral Filter',...
    'fontUnits','normalized',...
    'CallBack',@verticalIntegration_callBack,...
...
outputFile_path = uicontrol(GUIverticalIntegration_,'Style','edit',...
...
Cmenu = uicontextmenu(GUIverticalIntegration_);
set(GUIverticalIntegration_,'UIContextMenu',Cmenu)
uimenu(Cmenu,'Label','Copy the GUI variables into the MATLAB workspace','Callback',@copy2MATLABworkspace);

dataLoaded = 'n';
filterApplied = 'n';
set(GUIverticalIntegration_,'Visible','on')
%--------------------------------------------------------------------------
%CALLBACKS
%--------------------------------------------------------------------------
...
handles = guidata(GUIverticalIntegration_);
...
guidata(GUIverticalIntegration_,handles);
end

%PERFORM THE VERTICAL INTEGRATION
function verticalIntegration_callBack(varargin)
%Retrieve the handle structure
handles = guidata(GUIverticalIntegration_);
